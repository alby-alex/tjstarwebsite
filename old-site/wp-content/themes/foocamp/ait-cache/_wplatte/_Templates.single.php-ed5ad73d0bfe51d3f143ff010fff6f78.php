<?php //netteCache[01]000473a:2:{s:4:"time";s:21:"0.00189700 1427820982";s:9:"callbacks";a:3:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:84:"/afs/csl.tjhsst.edu/web/academics/srs/wp-content/themes/foocamp/Templates/single.php";i:2;i:1416516409;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:30:"eee17d5 released on 2011-08-13";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:21:"WPLATTE_CACHE_VERSION";i:2;i:4;}}}?><?php

// source file: /afs/csl.tjhsst.edu/web/academics/srs/wp-content/themes/foocamp/Templates/single.php

?><?php list($_l, $_g) = NCoreMacros::initRuntime($template, 'yn1vaqv3f3')
;//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb56c31b82c2_content')) { function _lb56c31b82c2_content($_l, $_args) { extract($_args)
?>
...
<?php NCoreMacros::includeTemplate("snippets/posted-on.php", $template->getParams(), $_l->templates['yn1vaqv3f3'])->render() ?>
...
<?php NCoreMacros::includeTemplate("comments.php", array('closeable' => $themeOptions->general->closeComments, 'defaultState' => $themeOptions->general->defaultPosition) + $template->getParams(), $_l->templates['yn1vaqv3f3'])->render() ?>
...
// block $sectionA
//
if (!function_exists($_l->blocks[$sectionA][] = '_lbc90aaab1a4__sectionA')) { function _lbc90aaab1a4__sectionA($_l, $_args) { extract($_args) ;NCoreMacros::includeTemplate("snippets/countdown.php", array('options' => $post->options('countdown')) + $template->getParams(), $_l->templates['yn1vaqv3f3'])->render() ;}} call_user_func(reset($_l->blocks[$sectionA]), $_l, get_defined_vars()) ?>

<?php isset($post->options('static-text')->overrideGlobal) ? $sectionB = 'sectionB' : $sectionB = 'xb' ;//
// block $sectionB
//
if (!function_exists($_l->blocks[$sectionB][] = '_lb736a9a343d__sectionB')) { function _lb736a9a343d__sectionB($_l, $_args) { extract($_args) ;NCoreMacros::includeTemplate("snippets/static-text.php", array('options' => $post->options('static-text')) + $template->getParams(), $_l->templates['yn1vaqv3f3'])->render() ;}} call_user_func(reset($_l->blocks[$sectionB]), $_l, get_defined_vars()) ;
