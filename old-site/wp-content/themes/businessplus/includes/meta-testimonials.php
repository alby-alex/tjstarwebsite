...
$meta_box_testimonial = array(
	...
	array(
			'name' =>  __('Author Avatar ', 'themejunkie'),
			'desc' => __('Upload an image or enter an URL to the avatar image (best size: 42 x 42)', 'themejunkie'),
			'id' => $prefix.'testimonial_author_avatar',
			'type' => 'text',
			'std' => get_bloginfo('template_url').'/images/default-avatar.png'
		),
	array(
			'name' => '',
			'desc' => '',
			'id' => $prefix.'testimonial_author_avatar_button',
			'type' => 'button',
			'std' => 'Browse'
		),
	array(
