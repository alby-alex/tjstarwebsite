...
if ($num_students == NULL) {
	...
	echo "<form name=\"nums\" method=\"get\" action=\"se_reg_2011.php\">\n";
...
<?php
$str = "<form name=\"register\" method=\"post\" action=\"se_ins_2011.php?num=" . $_GET['num'] . "\">\n";
echo $str;
echo "<p>\n";
for ($i = 1; $i <= (int)$_GET['num']; $i++) {
	...
	echo "<option value = \"Astronomy\">Astronomy and Astrophysics</option>\n";
	echo "<option value = \"Robotics\">Automation and Robotics</option>\n";
	echo "<option value = \"Biotech\">Biotechnology and Life Sciences</option>\n";
	echo "<option value = \"Chemical Analysis\">Chemical Analysis</option>\n";
	echo "<option value = \"Communication Systems\">Communication Systems</option>\n";
	echo "<option value = \"CAD\">Computer Aided Design</option>\n";
	echo "<option value = \"Computer Systems\">Computer Systems</option>\n";
	echo "<option value = \"Energy Systems\">Energy Systems</option>\n";
	echo "<option value = \"Microelectronics\">Microelectronics</option>\n";
	echo "<option value = \"Neuroscience\">Neuroscience</option>\n";
	echo "<option value = \"Oceanography\">Oceanography and Geophysical Systems</option>\n";
	echo "<option value = \"Physics\">Optics and Modern Physics</option>\n";
	echo "<option value = \"Prototyping\">Prototyping and Engineering Materials</option>\n";
	echo "</select>\n";
	echo "</td></table>\n";
	echo "<br>\n";
}
