...
<? $data = mysql_query("SELECT * FROM web_seniors WHERE `Presentation Title` LIKE'%$find%' OR Description LIKE'%$find%' OR Room LIKE'%$find%' OR `Name(s)` LIKE'%$find%'") ?>
...
<? $data = mysql_query("SELECT * FROM web_ibet WHERE `Presentation Title` LIKE'%$find%' OR Description LIKE'%$find%' OR Room LIKE'%$find%' OR `Name(s)` LIKE'%$find%'") ?>
