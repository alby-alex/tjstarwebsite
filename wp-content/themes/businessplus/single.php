<?php get_header(); ?>
    ...
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<?php get_template_part('includes/breadcrumbs'); ?>
		 	...
		 	<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="entry-meta">
			   	...
			   	<div class="entry-content">
					<?php if(get_option('businessplus_integrate_singletop_enable') == 'on') echo (get_option('businessplus_integration_single_top')); ?>	   	
		            <?php the_content(''); ?>
					<?php wp_link_pages( array( 'before' => '<div class="page-link">' . __( 'Pages:', 'themejunkie' ), 'after' => '</div>' ) ); ?>
					<?php if(get_option('businessplus_integrate_singlebottom_enable') == 'on') echo (get_option('businessplus_integration_single_bottom')); ?>				    	
			    	<div class="clear"></div>
		  	...
		  	<?php if(get_option('businessplus_show_author_box') == 'on') { ?>	  	
			  	<div class="authorbox">
	    	...
	    	<?php if(get_option('businessplus_show_post_comments') == 'on') { ?>
