...
$themename = "BusinessPlus";
$shortname = "businessplus";
	...
	array( "name" => "nav-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Footer Credit",
				   ...
				   "type" => "textarea",
				   "std" => "<a href=\"http://www.theme-junkie.com\">WordPress Business Theme</a> designed by <a href=\"http://www.theme-junkie.com\">Theme Junkie</a>",
				   "desc" => "desc",),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Facebook Page ID",
				   "id" => $shortname."_facebook_id",
				   "type" => "text",
				   "std" => "yourpage",
				   "desc" => "desc",),

			array( "name" => "Google+ Profile ID",
				   "id" => $shortname."_google_id",
				   "type" => "text",
				   "std" => "116387478398345310130",
				   "desc" => "desc",),				   			   
	...
	array( "name" => "nav-layout",
		...
		array( "name" => "layout-1",
            ...
            array( "name" => "Slogan",
                   ...
                   "type" => "textarea",
                   "std" => "<h1>Take Your Online Business To A Higher Level.</h1><p>We are a <a href='#'>creative studio</a> specialized into the creation of <a href='#'>digital designs</a>, products and resources.</p>",
				   "desc" => "desc."),				   
            ...
            array( "name" => "Enable Mini Features on homepage",
                   "id" => $shortname."_home_features_enable",
                   "type" => "checkbox",
                   "std" => "on",
				   "desc" => "desc."),

            array( "name" => "Number of Features to show",
                   "id" => $shortname."_home_features_num",
                   "type" => "text",
                   "std" => "6",
				   "desc" => "desc."),

            array( "name" => "Enable Random Testimonials on homepage",
                   "id" => $shortname."_home_testimonials_enable",
                   "type" => "checkbox",
                   "std" => "on",
				   "desc" => "desc."),				   			   			   			   				   
				   
            array( "name" => "Enable Blog Posts on homepage",
            ...
            array( "name" => "Enable Twitter Stream on homepage",
                   "id" => $shortname."_home_twitter_enable",
                   "type" => "checkbox",
                   "std" => "on",
				   "desc" => "desc."),

            array( "name" => "Number of tweets to show",
                   "id" => $shortname."_home_tweets_num",
                   "type" => "text",
                   "std" => "5",
				   "desc" => "desc."),

            array( "name" => "Enable Recent Portfolio on homepage",
                   "id" => $shortname."_home_work_enable",
                   "type" => "checkbox",
                   "std" => "on",
				   "desc" => "desc."),
            ...
            array( "name" => "Enable Newsletter Form on homepage",
                   "id" => $shortname."_home_newsletter_enable",
                   "type" => "checkbox",
                   "std" => "on",
				   "desc" => "desc."),				   					   				   				   				   					   
            ...
            array( "name" => "Footer Callout Right",
				   ...
				   "type" => "textarea",
				   "std" => "<img src='".get_template_directory_uri() . "/images/logo-twitter.png' alt=''/><img src='".get_template_directory_uri() . "/images/logo-facebook.png' alt=''/><img src='".get_template_directory_uri() . "/images/logo-redhat.png' alt=''/><img src='".get_template_directory_uri() . "/images/logo-microsoft.png' alt=''/><img src='".get_template_directory_uri() . "/images/logo-vmware.png' alt=''/><img src='".get_template_directory_uri() . "/images/logo-linkedin.png' alt=''/>",
				   "desc" => "desc",),
		...
		array( "name" => "layout-2",
            ...
            array( "name" => "Number of related posts to show on single portfolio pages",
                   "id" => $shortname."_related_portfolio_num",
                   "type" => "text",
                   "std" => "4",
                   "desc" => "desc. "),
            ...
            array( "name" => "Show comments on single portfolio pages",
